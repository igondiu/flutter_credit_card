      ...
      child: Form(
          ...
          children: <Widget>[
            Container(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value.isEmpty) {
                    return "Complétez votre numéro de carte";
                  } else {
                    return null;
                  }
                },
            ...
            Container(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value.isEmpty) {
                    return "Complétez votre date d'expiration";
                  } else {
                    return null;
                  }
                },
            ...
            Container(
              ...
              child: TextFormField(
                ...
                validator: (value) {
                  if (value.isEmpty) {
                    return "Complétez votre Nom et Prénom";
                  } else {
                    return null;
                  }
                },
        ...
        FlatButton(
          ...
          shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(4)),
            ...
            FlatButton(
              onPressed: (){widget.onCancelPayment();},
